...
import time 
#opt = pyo.SolverFactory("cplex", executable="C:\Users\Herena\Documents\GitLab\microgrids\env_microgrids\Scripts\cpoptimizer")
...
Renewable_Penetration  =  0.8 # a number from 0 to 1
Battery_Independency   =  3    # number of days of battery independency
Lost_Load_Probability  =  0.2  # Allowed percentage of unmed demand in the system, from 0 to 1.
Curtailment_Unitary_Cost =  0.15 # probando curtailment cost 0

S = 1 # Plot scenario
Plot_Date = '31/07/2017 00:00:00' # Day-Month-Year
PlotTime = 10 # Days of the plot
