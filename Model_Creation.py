...
def Model_Creation(model, Renewable_Penetration, Battery_Independency, Renewable_Limit= 100000, Battery_Limit = 700000,
                   ...
                   path_renewable= 'Inputs/Renewable_Energy.xls', path_demand = 'Inputs/Demand.xls'):
...
def Model_Creation_binary(model):
    ...
    from Initialize import Initialize_years, Initialize_Demand, Initialize_Renewable_Energy, Marginal_Cost_Generator, Start_Cost,Marginal_Cost_Generator_1 # Import library with initialitation funtions for the parameters
    ...
    model.PV_Energy_Production = Param(model.scenario, model.periods, within=NonNegativeReals, initialize=Initialize_Renewable_Energy) # Energy produccion of a solar panel in W
