...
def Model_Resolution(model,Renewable_Penetration, Battery_Independency,datapath="Inputs/data.dat", options_string="mipgap=0.05",
                     warmstart=False, keepfiles=False, load_solutions=False, logfile="Solver_Output.log", solver = 'cplex',
                     timelimit = 1800):   
    '''
...
def Model_Resolution_binary(model,datapath="Inputs/data_binary.dat"):   
    '''
    This function creates the model and call Pyomo to solve the instance of the proyect 
...
#    model.ScenarioNetPresentCost = Constraint(model.scenario, rule=Scenario_Net_Present_Cost) 
    ...
    instance = model.create_instance("Inputs/data_binary.dat") # load parameters       
...
def Model_Resolution_Dispatch(model,datapath="Inputs/data_Dispatch.dat", options_string="mipgap=0.005", solver = 'cplex',  timelimit = 1800):   
    '''
    This function creates the model and call Pyomo to solve the instance of the proyect 
...
#    opt.options['node_select'] = 3
    ...
    #adding  warmstart=True as parameter in this function may work for including the exe files for solvers
