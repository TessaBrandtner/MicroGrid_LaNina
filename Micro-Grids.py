...
if formulation == 'LP' or formulation == 'MILP':
    ...
    # Data Analisys
    Print_Results(instance, Generator_Data, Data_Renewable, Battery_Data, Results, formulation)
    ...
    Time_Series = Load_results1_binary(instance)  # Extract results of energy from instance and save it in a excel file
